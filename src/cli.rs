...
static VERSION: &str = "0.16.0";
static AUTHOR: &str = "sagiegurari";
static DESCRIPTION: &str = "The cargo-make task runner enables to define and configure sets of tasks and run them as a flow.";
...
/// Handles the command line arguments and executes the runner.
fn run_for_args(cmd_matches: ArgMatches, global_config: &GlobalConfig) {
